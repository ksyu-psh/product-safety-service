...
def result():
    ...
    #dataset['group_5'] = column_group_5
    dataset['Рекомендации по ТО'] = recomedations
    #dataset['Коэффициент схожести с рекомендацией'] = dataset.apply(lambda row: calculate_cosine_similarity(row['Рекомендации по ТО'], row['Техническое оборудование']), axis=1)
